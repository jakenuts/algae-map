...
export const BloomMarker: React.FC<BloomMarkerProps> = ({ bloom, onSelect, zIndexOffset }) => {
  ...
  return (
    <Marker position={position} icon={icon} zIndexOffset={zIndexOffset} eventHandlers={{ click: () => onSelect?.(bloom) }}>
